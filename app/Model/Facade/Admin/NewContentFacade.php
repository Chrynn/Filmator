...
final class NewContentFacade
{
	...
	static function changeBannerSize(string $imageName, string $imagePath): string
	{
	...
	static function changePosterSize(string $imageName, string $imagePath): string
	{
		$slug = Strings::webalize($imageName);
	...
	static function getSquareSize(string $imageName, string $imagePath): string
	{
		$slug = Strings::webalize($imageName);
	...
	static function getTrailerLink(string $link): string
	{
